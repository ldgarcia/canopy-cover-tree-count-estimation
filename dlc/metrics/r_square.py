# Modified TF Addons' implementation, hence named RSquareV2.
# Upstream is located here: https://git.io/JZHPs
...
class RSquareV2(Metric):
    ...
    def __init__(
        ...
        y_shape: Union[Tuple[int, ...], List[int]] = (),
        y_true_index: Optional[int] = None,
    ...
    def result(self) -> tf.Tensor:
        ...
        raw_scores = 1.0 - tf.math.divide_no_nan(self.res, total)
